...
exports.deleteRecipe = exports.updateRecipe = exports.getRecipeById = exports.getMyRecipes = exports.getRecipesByUser = exports.queryRecipes = exports.listRecipes = exports.addRecipe = void 0;
...
const addRecipe = async (req, res, next) => {
    try {
        ...
        if (!userId) {
            (0, libs_1.fail)(res, 'Authentication required. Please log in to create or update a recipe.', 401);
            return;
        }
        ...
        if (isUpdate) {
            ...
            const recipe = await RecipeService_1.default.updateRecipe(recipeId, userId, updates);
            libs_1.logger.info('Recipe updated', { recipeId: recipe._id, userId });
            (0, libs_1.success)(res, {
                recipeId: recipe._id,
                recipeName: recipe.basicInfo.recipeName,
            }, 'Recipe updated successfully', undefined, 200);
        }
        else {
...
const getMyRecipes = async (req, res, next) => {
    try {
        ...
        const { recipes } = await RecipeService_1.default.getRecipesByUser(userId, 1, 1000);
