...
class PostController {
    ...
    async getPostById(req, res) {
        try {
            ...
            libs_1.logger.error('Error fetching post', { error: error.message, postId: req.params.postId });
    ...
    async updatePost(req, res) {
        try {
            ...
            libs_1.logger.error('Error updating post', { error: error.message, postId: req.params.postId });
            if (error.isOperational) {
                res.status(error.statusCode).json({ success: false, message: error.message });
                return;
            }
    ...
    async deletePost(req, res) {
        try {
            ...
            libs_1.logger.error('Error deleting post', { error: error.message, postId: req.params.postId });
            if (error.isOperational) {
                res.status(error.statusCode).json({ success: false, message: error.message });
                return;
            }
    ...
    async votePost(req, res) {
        try {
            ...
            libs_1.logger.error('Error voting on post', { error: error.message, postId: req.params.postId });
            if (error.isOperational) {
                res.status(error.statusCode).json({ success: false, message: error.message });
                return;
            }
    ...
    async removeVote(req, res) {
        try {
            ...
            libs_1.logger.error('Error removing vote from post', { error: error.message, postId: req.params.postId });
            if (error.isOperational) {
                res.status(error.statusCode).json({ success: false, message: error.message });
                return;
            }
    ...
    async reactToPost(req, res) {
        try {
            ...
            libs_1.logger.error('Error reacting to post', { error: error.message, postId: req.params.postId });
            if (error.isOperational) {
                res.status(error.statusCode).json({ success: false, message: error.message });
                return;
            }
    ...
    async removeReaction(req, res) {
        try {
            ...
            libs_1.logger.error('Error removing reaction from post', { error: error.message, postId: req.params.postId });
            if (error.isOperational) {
                res.status(error.statusCode).json({ success: false, message: error.message });
                return;
            }
    ...
    async sharePost(req, res) {
        try {
            ...
            libs_1.logger.error('Error sharing post', { error: error.message, postId: req.params.postId });
            if (error.isOperational) {
                res.status(error.statusCode).json({ success: false, message: error.message });
                return;
            }
